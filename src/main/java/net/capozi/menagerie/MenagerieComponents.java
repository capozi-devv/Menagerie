...
public class MenagerieComponents implements EntityComponentInitializer {
    ...
    public void registerEntityComponentFactories(EntityComponentFactoryRegistry registry) {
        ...
        Menagerie.USAGE_TICKS = ComponentRegistry.getOrCreate(new Identifier(Menagerie.MOD_ID, "usageTicks"), UsageTickComponent.class);
        ...
        registry.registerForPlayers(Menagerie.USAGE_TICKS, player -> (UsageTickComponent) new UsageTickComponentImpl(), RespawnCopyStrategy.INVENTORY);
    }
}