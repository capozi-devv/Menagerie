...
const vec3 DARK_COLOR = vec3(0.0470588, 0.0980392, 0.0980392);
const vec3 BRIGHT_COLOR = vec3(0.0, 0.658824, 0.623529);
const vec3 BORDER_COLOR = vec3(0.0588235, 0.196078, 0.188235);
